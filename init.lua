...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:wooden_dagger 1",
    recipe = {
        {"", "", ""},
        {"", "group:wood", ""},
        {"medival_combat:handle", "", ""}
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:stone_dagger 1",
    recipe = {
        {"", "", ""},
        {"", "group:stone", ""},
        {"medival_combat:handle", "", ""}
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:bronze_dagger 1",
    recipe = {
        {"", "", ""},
        {"", "default:bronze_ingot", ""},
        {"medival_combat:handle", "", ""}
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:steel_dagger 1",
    recipe = {
        {"", "", ""},
        {"", "default:steel_ingot", ""},
        {"medival_combat:handle", "", ""}
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:mese_dagger 1",
    recipe = {
        {"", "", ""},
        {"", "default:mese_crystal", ""},
        {"medival_combat:handle", "", ""}
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:diamond_dagger 1",
    recipe = {
        {"", "", ""},
        {"", "default:diamond", ""},
        {"medival_combat:handle", "", ""}
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:wooden_halberd 1",
    recipe = {
        {"group:wood", "group:wood", ""},
        {"group:wood", "default:stick", "group:wood"},
        {"", "medival_combat:pole", ""}
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:stone_halberd 1",
    recipe = {
        {"group:stone", "group:stone", ""},
        {"group:stone", "default:stick", "group:stone"},
        {"", "medival_combat:pole", ""}
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:bronze_halberd 1",
    recipe = {
        {"default:bronze_ingot", "default:bronze_ingot", ""},
        {"default:bronze_ingot", "default:stick", "default:bronze_ingot"},
        {"", "medival_combat:pole", ""}
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:steel_halberd 1",
    recipe = {
        {"default:steel_ingot", "default:steel_ingot", ""},
        {"default:steel_ingot", "default:stick", "default:steel_ingot"},
        {"", "medival_combat:pole", ""}
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:mese_halberd 1",
    recipe = {
        {"default:mese_crystal", "default:mese_crystal", ""},
        {"default:mese_crystal", "default:stick", "default:mese_crystal"},
        {"", "medival_combat:pole", ""}
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:diamond_halberd 1",
    recipe = {
        {"default:diamond", "default:diamond", ""},
        {"default:diamond", "default:stick", "default:diamond"},
        {"", "medival_combat:pole", ""}
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:wooden_great_sword 1",
    recipe = {
        {"", "group:wood", ""},
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:stone_great_sword 1",
    recipe = {
        {"", "group:stone", ""},
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:bronze_great_sword 1",
    recipe = {
        {"", "default:bronze_ingot", ""},
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:steel_great_sword 1",
    recipe = {
        {"", "default:steel_ingot", ""},
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:mese_great_sword 1",
    recipe = {
        {"", "default:mese_crystal", ""},
...
minetest.register_craft({
    type = "shaped",
    output = "medival_combat:diamond_great_sword 1",
    recipe = {
        {"", "default:diamond", ""},
